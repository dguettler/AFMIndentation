...
================================
-run_AFMIndentation.sh (shell script run to temporarily set environment variables and 
 execute the application)
   -to run the shell script, type
   
       ./run_AFMIndentation.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v715, run the shell script as:
       ...
       ./run_AFMIndentation.sh /mathworks/home/application/R2010a/v715
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_AFMIndentation.sh /mathworks/devel/application/matlab
-MCRInstaller.dmg 
   -include when building component by clicking "Add MCR" link 
    in deploytool
-The Macintosh bundle directory structure AFMIndentation.app 
   -this can be gathered up using the zip command 
    zip -r AFMIndentation.zip AFMIndentation.app
    or the tar command 
    tar -cvf AFMIndentation.tar AFMIndentation.app
-This readme file 
...
A. On the target machine, add the MCR directory to the environment variable DYLD_LIBRARY_PATH.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_AFMIndentation.sh 
